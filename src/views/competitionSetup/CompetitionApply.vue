  ...
  <v-form ref="competition_form">
    <v-row>
      ...
      <v-col cols="12" sm="12" md="12" lg="12" xl="12">
        ...
        <v-btn color="success" class="ml-4">保存</v-btn></v-col
      >
    </v-row>
  </v-form>
</template>
...
import CompetitionStage from "./components/CompetitionStage";
export default {
  ...
  data: () => ({
    competitionForm: {
      ...
      startTime: "",
      endTime: "",
      principal: store.getters["user/info"].name
    },
    /** 部门选项 */
  ...
  methods: {
    reset() {
      this.$refs.competition_form.reset();
    }
  },
  components: { CompetitionStage }
};
</script>
